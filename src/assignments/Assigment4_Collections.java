...
public class Assigment4_Collections {
	...
	public static void main(String[] args) {
		...
		// Delhi (1484), Bangalore (741), Visakhapatnam (681.96), Hyderabad (650), and Lucknow (631)
		...
		//The top 5 highest-grossing movies of all time are: Avatar, Avengers: Endgame, Avatar: The Way of Water, Titanic, and Star Wars:The Force Awakens
